...
public class PerfilActivity extends AppCompatActivity {
                ...
                eliminarCuenta.setMessage(R.string.eliminar_cuenta_mensaje)
                        ...
                        .setPositiveButton(R.string.aceptar, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.cancel();
                                myRef.child(key).child("verificado").setValue(false);
                                user.delete();
    ...
    public void comprobarDatos() {
        ...
        if (!(editTextEmail.getText().toString()).equalsIgnoreCase(user.getEmail())) { //Si el correo se ha cambiado
        ...
        if (!(editTextNombre.getText().toString()).equals(user.getDisplayName()) || !(editTextEmail.getText().toString()).equalsIgnoreCase(user.getEmail())) {
